 ...
 * @version $Id: Configuration.java 432 2010-10-14 16:01:51Z david $
 */
public class Configuration {
    ...
    private List<String> enabledAddins = new ArrayList<>();
    ...
    public Configuration(Configuration c) {
        ...
        enabledAddins = new ArrayList<>(c.enabledAddins);
    }
    ...
    public List<Addin> getEnabledAddinsAsAddins() {
        ...
        List<Addin> addins = new ArrayList<>(enabledAddins.size());
    ...
    public boolean equals(Object o) {
        ...
        if (resolution != null ? !resolution.equals(that.resolution) : that.resolution != null)
            return false;
        if (refreshRate != null ? !refreshRate.equals(that.refreshRate) : that.refreshRate != null)
            return false;
        if (watermark != null ? !watermark.equals(that.watermark) : that.watermark != null)
            return false;
